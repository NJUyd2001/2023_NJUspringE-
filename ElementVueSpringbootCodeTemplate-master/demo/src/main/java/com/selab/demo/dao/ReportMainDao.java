...
public interface ReportMainDao {
    ...
    @Insert("INSERT INTO selabspringe.reportmain (client,samplename,version,sampledate,typetest,testtime,developmentcompany,samplestatus,neededstandard,samplelist,testconclusion,organizer,sampledate1,auditor,sampledate2,approver,sampledate3) VALUES (#{client},#{samplename},#{version},#{sampledate},#{typetest},#{testtime},#{developmentcompany},#{samplestatus},#{neededstandard},#{samplelist},#{testconclusion},#{organizer},#{sampledate1},#{auditor},#{sampledate2},#{approver},#{sampledate3})")
    ...
    @Update("UPDATE selabspringe.reportmain SET client=#{client},samplename=#{samplename},version=#{version},sampledate=#{sampledate},typetest=#{typetest},testtime=#{testtime},developmentcompany=#{developmentcompany},samplestatus=#{samplestatus},neededstandard=#{neededstandard},samplelist=#{samplelist},testconclusion=#{testconclusion},organizer=#{organizer},sampledate1=#{sampledate1},auditor=#{auditor},sampledate2=#{sampledate2},approver=#{approver},sampledate3=#{sampledate3} WHERE RID = #{RID}")
